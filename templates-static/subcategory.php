...
<head>
    ...
    <title id="page-title">Wypożyczalnia narzędzi – [SubcategoryName] | ToolShare</title>
    <meta name="description" content="Podkategorie narzędzi – ToolShare. Wypożycz sprawdzony sprzęt szybko i wygodnie: elastyczne godziny, lokalna obsługa i atrakcyjne ceny." id="meta-description">
    ...
    <meta property="og:title" content="Podkategorie – ToolShare" id="og-title">
    <meta property="og:description" content="Podkategorie narzędzi do wypożyczenia – elastyczne godziny, lokalna obsługa i atrakcyjne ceny." id="og-description">
    <meta property="og:url" content="https://toolshare.com.pl/subcategory.html" id="og-url">
    <meta property="og:image" content="https://toolshare.com.pl/images/logo.webp">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <!-- Fallback OG tags for SSR/prerender -->
    <meta property="og:title" content="Wypożyczalnia narzędzi – [SubcategoryName] | ToolShare">
    <meta property="og:description" content="Lista narzędzi w podkategorii [SubcategoryName]. Sprawdź dostępność i ceny wynajmu.">
    ...
    <meta name="description" content="Lista narzędzi w podkategorii [SubcategoryName]. Kliknij, aby zobaczyć szczegóły i ceny wynajmu." id="meta-description-fallback">
    <!-- Fallback Twitter tags for SSR/prerender -->
    <meta name="twitter:title" content="Wypożyczalnia narzędzi – [SubcategoryName] | ToolShare">
    <meta name="twitter:description" content="Lista narzędzi w podkategorii [SubcategoryName]. Sprawdź dostępność i ceny wynajmu.">
    <meta name="twitter:title" content="Podkategorie – ToolShare" id="twitter-title">
    <meta name="twitter:description" content="Podkategorie narzędzi – wypożyczalnia ToolShare. Atrakcyjne ceny i lokalna obsługa." id="twitter-description">
        ...
        <section class="content-section">
            <div class="container">
                <nav class="breadcrumb" aria-label="Breadcrumb">
                    <!-- Ścieżka nawigacyjna będzie budowana dynamicznie przez JavaScript -->
                ...
                <h1 id="subcategory-title">Nazwa Podkategorii</h1>
                <div id="tools-grid" class="tools-grid">
                    <!-- Narzędzia z podkategorii będą wstawiane tutaj -->
                </div>
            </div>
        </section>
    </main>
