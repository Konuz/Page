...
<head>
    ...
    <title id="page-title">Wypożyczalnia narzędzi – [CategoryName] | ToolShare</title>
    <meta name="description" content="Narzędzia według kategorii – ToolShare. Sprawdzony sprzęt do wypożyczenia od ręki: elastyczne godziny, lokalna obsługa i atrakcyjne ceny." id="meta-description">
    ...
    <meta property="og:title" content="Kategorie – ToolShare" id="og-title">
    <meta property="og:description" content="Narzędzia według kategorii – wypożyczalnia ToolShare. Elastyczne godziny, lokalna obsługa i atrakcyjne ceny." id="og-description">
    <meta property="og:url" content="https://toolshare.com.pl/category.html" id="og-url">
    <meta property="og:image" content="https://toolshare.com.pl/images/logo.webp">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <!-- Fallback OG tags for SSR/prerender -->
    <meta property="og:title" content="Wypożyczalnia narzędzi – [CategoryName] | ToolShare">
    <meta property="og:description" content="Lista narzędzi w kategorii [CategoryName]. Sprawdź dostępność i ceny wynajmu.">
    ...
    <meta name="twitter:title" content="Wypożyczalnia narzędzi – [CategoryName] | ToolShare">
    <meta name="twitter:description" content="Lista narzędzi w kategorii [CategoryName]. Sprawdź dostępność i ceny wynajmu.">
    <meta name="twitter:title" content="Kategorie – ToolShare" id="twitter-title">
    <meta name="twitter:description" content="Narzędzia według kategorii – wypożyczalnia ToolShare. Elastyczne godziny i atrakcyjne ceny." id="twitter-description">
    ...
    <main>
        <section class="content-section">
            <div class="container">
                ...
                <h1 id="category-title">Nazwa Kategorii</h1>
                <div id="subcategory-grid" class="tools-grid">
                    <!-- Podkategorie będą dynamicznie wstawiane tutaj -->
                </div>
            </div>
        </section>
    </main>
